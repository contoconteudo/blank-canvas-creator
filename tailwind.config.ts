    ...
    extend: {
      ...
      colors: {
        ...
        priority: {
          ...
          problematic: "hsl(var(--priority-problematic))",
          important: "hsl(var(--priority-important))",
          default: "hsl(var(--priority-default))",
        },
        status: {
        ...
        period: {
          morning: "hsl(var(--period-morning))",
          afternoon: "hsl(var(--period-afternoon))",
          night: "hsl(var(--period-night))",
        },
        project: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 16px -4px hsl(var(--primary) / 0.4)" },
